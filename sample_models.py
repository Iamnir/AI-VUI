...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    # Add recurrent layer
    simp_rnn = SimpleRNN(units, activation='relu',
        return_sequences=True, implementation=2, name='rnnI')(input_data)
    # TODO: Add batch normalization 
    bn_rnn = BatchNormalization()(simp_rnn)

    # Add recurrent layer
    simp_rnn2 =  SimpleRNN(units, activation='relu',
        return_sequences=True, implementation=2, name='rnnII')(bn_rnn)
    # TODO: Add batch normalization 
...
def final_model():
    ...
    bidir_rnn = Bidirectional(GRU(units, activation='relu',
       return_sequences=True, implementation=2, dropout_W=drop, dropout_U=drop,name='rnn'))(bn_cnn)
    # TODO: Add batch normalization
    bn_rnn = BatchNormalization(name='bn_rnn')(bidir_rnn)
    
    bidir_rnn2 = Bidirectional(GRU(units, activation='relu',
       return_sequences=True, implementation=2, dropout_W=drop, dropout_U=drop,name='rnn2'))(bn_rnn)
    # TODO: Add batch normalization
